		...
		<div class="row justify-content-center">
				...
				<div class="row">
					<div class="col-lg-6 col-sm-12 mt-4">
						<a href="<?php echo $data->instagram_link; ?>" target="_blank">
							<button type="button" class="btn btn-primary w-100 instagram fw-bold home-button" style="color:#000;"><i class="fab fa-instagram"></i>&nbsp;<?php echo $data->instagram_name; ?></button>
						</a>
					</div>
					<div class="col-lg-6 col-sm-12 mt-4">
						<a href="<?php echo $data->youtube_link; ?>" target="_blank">
							<button type="button" class="btn btn-primary w-100 fw-bold home-button" style="background-color:#F00; color:#000;"><i class="fab fa-youtube"></i>&nbsp;<?php echo $data->youtube_name; ?></button>
						</a>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-sm-12 text-center mt-4">
				...
				<a href="<?php echo base_url()."connectwithus" ?>">
					<button type="button" class="btn btn-primary w-100 fw-bold home-button mt-4" style="background-color:#FFF; color: #000"><i class="fal fa-map-marker-alt"></i>&nbsp;Find your area</button>
				</a>
			</div>
		</div>
		<br/>
